...
countries <- c("AT", "BE","BE_ext", "HR", "DK", "EE", "FI", "FR", "GR", "HU", 
...
for (country in countries) {
  fit <- nuts_fit(country, n_chains, n_warmups, n_iter, n_thin, n_adapt_delta, n_max_treedepth)
...
for (country in countries) {
  ...
  if (!is.null(fig2)) {
    png(filename = paste0('C:/Users/zd22230/OneDrive - University of Bristol/ContactPatternsAC/Rfiles/Figures/fitC_knots50/', country, '_fitted_contacts.png'),
